# "Fri Nov 09 06:43:07 2018"
#  TukeyHSD OK
#  glht nicht konsistent  (APA2 und APA_Table liefert anders formatierte Tabellen)
...
APA2.glht <-
  function(x,
    ...
    if (include.ci) {
      # Entweder CI oder SE
      res <-
        cbind(res[1:2],  confint(x, level = level)$confint[, 2:3], res[4:ncol(res)])
    }

# roxygen "Tue Oct 16 08:03:40 2018"
...
#' @rdname Kano
#' @param na.action an Kano.data.frame
Kano.data.frame <- function(x,
                            na.action = na.pass, ...) {
...
#' @rdname Kano
#' @param x,data,subset,na.action  an Kano.formula
Kano.formula <-
  function(x,
           data,
           subset,

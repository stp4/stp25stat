...
```{rrank-apa, results='asis', warning=FALSE}
...
```{r surv-data, results='asis', warning=FALSE}
library(survival)
...
```{r tab-surv-summary, results='asis', warning=FALSE}
...
```{r tab-surv-fit, results='asis', warning=FALSE}
